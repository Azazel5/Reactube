...
describe('api reducer', () => {
  test('unused action type with default initial state', () => {
  ...
  test('api reducer with YOUTUBE_LIBRARY_LOADED action', () => {
  ...
  test('api reducer for idempotence with YOUTUBE_LIBRARY_LOADED action and library already loaded', () => {
    const startState = {
      libraryLoaded: true,
    };
